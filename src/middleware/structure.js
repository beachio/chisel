import {INIT_END as INIT_END_models, SITE_ADD, SET_CURRENT_MODEL, COLLABORATION_ADD, COLLABORATION_UPDATE, COLLABORATION_DELETE, COLLABORATION_SELF_DELETE, MODEL_ADD, setCurrentSite} from 'ducks/models';
...
export const structure = store => next => action => {
  ...
  if (action.type == COLLABORATION_DELETE || action.type == COLLABORATION_SELF_DELETE)
